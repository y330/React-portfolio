...
const Footer = () => {
    return (
        <motion.section
            ...
            animate="animate"
        >
            <motion.div className="mx-auto pb-14 flex w-[90%] flex-row items-center justify-between text-center text-[12px] text-[#e4ded7] sm:text-[12px] md:text-[14px] lg:max-w-[1440px] lg:text-[14px]">
                <AnimatedBody
                    text={"© Yonah Aviv 2025"}
                    className={"m-0 p-0"}
                />
